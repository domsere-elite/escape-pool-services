...
function V1Page() {
  ...
  const heroH1 = {
    outcome: <>Your pool, <span style={{ color: t.gold, fontStyle: "italic", fontFamily: "'DM Serif Display', Georgia, serif", fontWeight: 400 }}>this clean.</span> Every week.</>,
    price: <>Weekly pool care, <span style={{ color: t.gold, fontStyle: "italic", fontFamily: "'DM Serif Display', Georgia, serif", fontWeight: 400 }}>from $199</span> a month.</>,
    offer: <>A weekly pool service with a <span style={{ color: t.gold, fontStyle: "italic", fontFamily: "'DM Serif Display', Georgia, serif", fontWeight: 400 }}>$125 welcome</span>.</>,
    local: <>Spring's <span style={{ color: t.gold, fontStyle: "italic", fontFamily: "'DM Serif Display', Georgia, serif", fontWeight: 400 }}>weekly</span> pool service.</>,
  }[headline];
    ...
    <div className="v1" style={{
        ...
        <div className="v1-container v1-trust-strip" style={{ padding: "30px 0", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24 }}>
          {[
            ...
            <div key={s.l} style={{
              ...
              <div style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 36, fontWeight: 500, lineHeight: 1, color: t.ink, letterSpacing: "-0.02em" }}>{s.n}</div>
        ...
        <div className="v1-container">
          <div style={{ display: "grid", gridTemplateColumns: "1.05fr 1fr", gap: 64, alignItems: "start" }} className="v1-included">
            <div>
              ...
              <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 400, margin: "0 0 18px", lineHeight: 1.05, letterSpacing: "-0.02em" }}>
            ...
            <aside style={{
              ...
              <div style={{ position: "relative" }}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: 4, fontWeight: 500, lineHeight: 0.9, letterSpacing: "-0.04em", fontFamily: "'DM Serif Display', Georgia, serif" }}>
      ...
      <section style={{ padding: "88px 0", background: t.paperDeep, borderTop: `1px solid ${t.rule2}`, borderBottom: `1px solid ${t.rule2}` }}>
        <div className="v1-container">
          <div style={{ textAlign: "center", marginBottom: 48, maxWidth: 640, marginLeft: "auto", marginRight: "auto" }}>
            ...
            <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: "clamp(30px, 4vw, 44px)", fontWeight: 400, margin: 0, letterSpacing: "-0.02em", lineHeight: 1.05 }}>
            ...
            {[
              ...
              <div key={s.n} style={{ background: "#fff", borderRadius: 12, padding: 28, border: `1px solid ${t.rule2}`, position: "relative" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                  <span style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 28, fontWeight: 500, color: t.gold, letterSpacing: "-0.02em", lineHeight: 1 }}>{s.n}</span>
      ...
      <section style={{ padding: "88px 0", background: t.paper }}>
        <div className="v1-container">
          <div style={{ textAlign: "center", marginBottom: 44 }}>
            ...
            <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: "clamp(28px, 3.6vw, 40px)", fontWeight: 400, margin: 0, letterSpacing: "-0.02em" }}>
          ...
          <article style={{
            ...
            <div style={{ padding: "36px 38px" }}>
              ...
              <blockquote style={{ margin: "14px 0 22px", fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 22, lineHeight: 1.4, fontWeight: 400, letterSpacing: "-0.005em", color: t.ink }}>
      ...
      <section style={{ padding: "76px 0", background: t.ink, color: "#fff", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div className="v1-container" style={{ position: "relative" }}>
          ...
          <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: "clamp(36px, 5vw, 60px)", fontWeight: 400, margin: "0 0 16px", letterSpacing: "-0.02em", lineHeight: 1.05 }}>
      ...
      <section style={{ padding: "80px 0", background: t.paper }}>
        <div className="v1-container" style={{ maxWidth: 760 }}>
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: "clamp(28px, 3.6vw, 38px)", fontWeight: 400, margin: 0, letterSpacing: "-0.02em" }}>
              Before you sign up.
            </h2>
          </div>
          {[
            ...
            <details key={q} style={{ borderTop: `1px solid ${t.rule2}`, padding: "20px 4px" }}>
              <summary style={{ cursor: "pointer", fontWeight: 600, fontSize: 16.5, listStyle: "none", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, letterSpacing: "-0.005em" }}>
                {q}
                <span style={{ color: t.gold, fontWeight: 400, fontSize: 24, lineHeight: 1, fontFamily: "'DM Serif Display', Georgia, serif" }}>+</span>
              </summary>
      ...
      <section style={{ background: t.ink, color: "#fff", padding: "72px 0", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div className="v1-container" style={{ position: "relative" }}>
          <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: "clamp(30px, 4vw, 46px)", fontWeight: 400, margin: "0 0 14px", letterSpacing: "-0.02em", lineHeight: 1.05 }}>
